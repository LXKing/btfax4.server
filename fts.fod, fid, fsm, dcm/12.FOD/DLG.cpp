...
BOOL CFODDlg::OnInitDialog()
{
	...
	CFsmIfThread::Inst()->RcvPacket_Init( CConfig::FAX_START_CH, CConfig::FAX_TOTAL_CH_CNT );

	// P5. Status INI 초기화
	CStatusIni::Inst()->Initialize( CConfig::STATUS_FILE, 
									'O', 
									CConfig::FAX_START_CH, CConfig::FAX_TOTAL_CH_CNT, 
									CConfig::FAX_CH_beg,	CConfig::FAX_CH_end, 
									CConfig::FAX_BCH_beg, CConfig::FAX_BCH_end );
