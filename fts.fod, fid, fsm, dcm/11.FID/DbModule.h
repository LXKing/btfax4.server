...
public:
	int	InsertRecvInfo(int channel, CDbModule::RECV_INFO& recvInfo, CString* pstrFaxId);
	int	InsertRecvInfoEx(int channel, CString pstrMgwIp, int mgwPort, CDbModule::RECV_INFO& recvInfo, CString* pstrFaxId);
