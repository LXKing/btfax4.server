...
namespace AdapterOut
{
    static class Program
    {
        ...
        static void Main(string[] strArgs)
        {
			...
			AppLog.LogPrefix = string.Format("FAX_{0}_AOB_{1}", Config.SYSTEM_NO, Config.PROCESS_NO);
            ...
            AppLog.Write(LOG_LEVEL.MSG, string.Format("### AOB {0} 프로세스  시작 ###", Config.APP_VER));
#if DEBUG
            ...
            //// 쓰레드 객체 생성 ////
            s_tcpListentThread = TcpListenThread.Instance;
            ...
            //// 프로세스 종료 로그 기록 ////
            AppLog.Write(LOG_LEVEL.MSG, "### AOB 프로세스  종료 ###");
        }
        ...
        static public void Thread_Start()
        {
            ...
            s_tcpListentThread.StartThread();
        }

        static public void Thread_Stop()
        {
            BtfaxThread.Stop = true;
            s_tcpListentThread.JoinThread();
        }
        #endregion

        #region static
        public static FrmMain s_frmMain = null;
        public static TcpListenThread s_tcpListentThread = null;
        #endregion
    }
}
