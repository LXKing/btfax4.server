...
namespace PostFcs
{
    static class Program
    {
        ...
        static void Main(string[] strArgs)
        {
            ...
            AppLog.LogPrefix = string.Format("FAX_{0}_PSC_{1}", Config.SYSTEM_NO, Config.PROCESS_NO);
            ...
            AppLog.Write(LOG_LEVEL.MSG, string.Format("### PSC {0} 프로세스 시작 ###", Config.APP_VER));
#if DEBUG
            ...
            //// 프로세스 종료 로그 기록 ////
            AppLog.Write(LOG_LEVEL.MSG, "### PSC 프로세스  종료 ###");
        }
