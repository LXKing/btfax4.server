...
namespace FaxAgent.Server
{
    static class Program
    {
        ...
        public static void Thread_Start()
        {
            ...
            Program.s_TcpSocketListener.StartThread();
            Program.s_UdpSocketListener.StartThread();
        }

        public static void Thread_Stop()
        {
            BtfaxThread.Stop = true;
            Program.s_TcpSocketListener.JoinThread();
            Program.s_UdpSocketListener.JoinThread();
        }
        #endregion
        ...
        // 쓰레드
        public static TcpSocketThread s_TcpSocketListener = null;
        public static UdpSocketThread s_UdpSocketListener = null;
        #endregion
    }
}
